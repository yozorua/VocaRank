...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full h-[var(--header-height)] glass-panel z-50 flex items-center justify-center border-b-0 neon-border-bottom">
            <div className="w-full max-w-[var(--max-width)] px-6 flex items-center justify-between">
                {/* Logo */}
                <Link href="/" className="text-3xl font-bold tracking-tighter group flex items-center gap-2">
